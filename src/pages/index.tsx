...
function HomePage() {
  return (
    <>
      <Head>
        <title>RecipeApp v13</title>

        <meta
          name="description"
          content="Empower Your Culinary Journey with RecipeApp v13: Discover, Review, and Master Delectable Dishes Tailored to Your Taste and Skill Level"
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower Your Culinary Journey with RecipeApp v13: Discover, Review, and Master Delectable Dishes Tailored to Your Taste and Skill Level`}
            </Text>
